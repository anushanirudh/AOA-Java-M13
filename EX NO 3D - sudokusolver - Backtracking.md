...
public class SudokuSolver {
    ...
    static boolean solveSudoku(int[][] board, int row, int col) {
        // If reached end of the board, puzzle is solved
        if (row == 9)
            return true;
...
## Output:
<img width="948" height="620" alt="image" src="https://github.com/user-attachments/assets/83e68ce7-b012-465d-9c3d-5e6275bab167" />
